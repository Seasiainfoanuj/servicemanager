class CreateOnHireReports < ActiveRecord::Migration
  def change
    create_table :on_hire_reports do |t|
      t.references :hire_agreement, index: true
      t.references :user, index: true
      t.integer :odometer_reading
      t.datetime :report_time
      t.string :pickup_person_first_name
      t.string :pickup_person_last_name
      t.string :pickup_person_phone
      t.string :pickup_person_licence_number

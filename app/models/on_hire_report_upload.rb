class OnHireReportUpload < ActiveRecord::Base
  belongs_to :on_hire_report

  validates :on_hire_report_id, presence: true
  ...
  def to_jq_upload
    {
      ...
      "delete_url" => on_hire_report_upload_path(self),
      "delete_type" => "DELETE" 
    }
  end
end

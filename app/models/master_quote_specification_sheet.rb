class MasterQuoteSpecificationSheet < ActiveRecord::Base
  belongs_to :master_quote

  validates :master_quote_id, presence: true
  ...
  def to_jq_upload
    {
      ...
      "delete_url" => master_quote_specification_sheet_path(self.master_quote, self),
      "delete_type" => "DELETE"
    }
  end
end

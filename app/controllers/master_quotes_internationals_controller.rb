class MasterQuotesInternationalsController < ApplicationController
layout :resolve_layout
  ...
  #add_crumb("Master Quotes International") { |instance| instance.send :master_quotes_internationals_path }

  def index
    respond_to do |format|
      format.html
      format.json { render json: MasterQuotesInternationalsDatatable.new(view_context, current_user) }
    end
  end
  ...
  def create
    ...
    if @master_quote.save
      ...
      flash[:success] = "Master quote international created."
  ...
  def duplicate
    ...
    if @master_quote.save
      ...
      redirect_to edit_master_quotes_international_path(@master_quote)
    else
  ...
  def edit
    add_crumb @master_quote.name, master_quotes_international_path(@master_quote)
    add_crumb 'Edit'
  end
  ...
  def update
    if @master_quote.update(master_quote_params_modified)
      ...
      flash[:success] = "Master quote international updated."
  ...
  def destroy
    ...
    flash[:success] = "Master quote international deleted."
